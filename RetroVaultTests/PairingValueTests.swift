...
struct PairingValueTests {
  ...
  func usesStableLogSubsystem() {
    #expect(RetroVaultLog.subsystem == "org.kennethreitz.RetroVault")
  }
}
...
struct RomMAPIClientTests {
  ...
  func uploadsCartridgeSave() async throws {
    ...
    StubURLProtocol.handler = { request in
      ...
      #expect(queryItems.contains(URLQueryItem(name: "emulator", value: "RetroVault")))
    ...
    #expect(uploaded.emulator == "RetroVault")
  }
