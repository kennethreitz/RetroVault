    ...
    var body: some View {
        VStack(spacing: 26) {
            ...
            VStack(spacing: 8) {
                ...
                Text("Pair RetroVault with the server that already holds your library.")
